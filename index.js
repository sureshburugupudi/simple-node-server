...
var server = http.createServer(function (req, res) {
    if (req.url == '/') {
        ...
        res.write('<html><body><p>hiii.This is the Default Page of the Server and its working fine. If You have not specified anything or a Address, this page should be visible. This is the update on 29-Sep-2023. This update is very important.</p></body></html>');
        res.end();

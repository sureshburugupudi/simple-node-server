...
var server = http.createServer(function (req, res) {
    if (req.url == '/') {
        ...
        res.write('<html><body><p>This is the Default Page . If You have not specified anything or a Address, this page should be visible. This is the update on 26-Sep-2023</p></body></html>');
        res.end();

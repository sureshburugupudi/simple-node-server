...
var server = http.createServer(function (req, res) {
    if (req.url == '/') {
        ...
        res.write('<html><body><p>This is the Default Page of thie site of owner of aws.If You have not specified anything or a Address, this page should be invisible.This is the update on 5th-jan-2024</p></body></html>');
        res.end();
